  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      child: Container(
        ...
        child: Card(
          elevation: isPending || isOverdue ? 2 : 1,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
            side: (isPending || isOverdue)
                ? BorderSide(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 2.w),
                        Text(
                          (isPending || isOverdue) ? 'Due Date' : paymentMethod,
                          style:
                    ...
                    Row(
                      children: [
                        ...
                        // Show Pay Now button for both pending AND overdue transactions
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 3.h),
            // Pay Now action for both pending and overdue
            if ((isPending || isOverdue) && status.toLowerCase() != 'paid')
              _buildActionTile(
                context,
